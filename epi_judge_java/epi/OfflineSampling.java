...
public class OfflineSampling {
    /*
    Pretty much had to look at the book solution since the premise was a bit unclear
    I tried to optimize by removing elements from the set when k > A.size() - k, but it didn't take...
    Time: O(k), as we perform k swaps
